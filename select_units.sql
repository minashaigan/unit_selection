...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2016 at 11:16 PM
...
INSERT INTO `student` (`name`, `field`, `password`, `std_id`, `selu_id`, `average`, `being_id`) VALUES
('مینا شایگان', 'رياضيات و كاربردها', 'mina', 9212026, 1, 19, 1),
('ساحل بلوکات', 'علوم کامپیوتر', 'sahel', 9213017, 3, 17, 1),
('پریسا وقفی ', 'رياضيات و كاربردها', 'parisa', 9212051, 4, 20, 1),
('رویا صادقی', 'رياضيات و كاربردها', 'roya', 9212025, 5, 20, 1),
('1', '1', '1', 1, 2, 1, 1);
